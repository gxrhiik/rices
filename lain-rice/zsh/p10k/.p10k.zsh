# Generated by Powerlevel10k configuration wizard on 2025-11-11 at 00:06 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=$lain1
  # Red prompt symbol if the last command failed.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=$lain2
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND="%B${white}"
  ...
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE="%B%F{$lain2}%n%f%F{$lain1}@%f%F{$lain2}%m%f%b"
